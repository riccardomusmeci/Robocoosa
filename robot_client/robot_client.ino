...
void prendiDecisione(int velocitaRuotaSx, int velocitaRuotaDx, int con_oggetto){
    ...
    if(con_oggetto == 1){
      Serial.println("Ho la barra abbassata, faccio gli switch necessari");
      IRTopVal = IRBarraFrontVal;
      IRFrontDxVal = IRBarraDxVal;
      IRFrontSxVal = IRBarraSxVal;
      Serial.print("IRBarraFrontVal: "); Serial.print(IRBarraFrontVal); Serial.print("IRTopVal: "); Serial.println(IRTopVal);
      Serial.print("IRBarraSxVal: "); Serial.print(IRBarraSxVal); Serial.print("IRFrontSxVal: "); Serial.println(IRFrontSxVal);
      Serial.print("IRBarraDxVal: "); Serial.print(IRBarraDxVal); Serial.print("IRFrontDxVal: "); Serial.println(IRFrontDxVal);
    } 
    ...
    if(IRTopVal == 1 && IRFrontDxVal == 1 && IRFrontSxVal == 1 && IRLeftVal == 1 && IRRightVal == 1){
        ...
        while (millis() - t0 < 300){
            ...
            if (IRLeftVal == 0 || IRFrontVal == 0 || IRRightVal == 0 || IRTopVal == 0 || IRFrontDxVal == 0 || IRFrontSxVal == 0){
              Serial.println("Ho individuato un ostacolo andando dritto");
              fermati(); 
              root["vengoDa"] = 0;
            }
        }
